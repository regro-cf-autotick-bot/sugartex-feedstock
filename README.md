...
All platforms:
[![noarch](https://img.shields.io/circleci/project/github/conda-forge/sugartex-feedstock/master.svg?label=noarch)](https://circleci.com/gh/conda-forge/sugartex-feedstock)
...
Once the `conda-forge` channel has been enabled, `sugartex` can be installed with:

```
conda install sugartex
```

It is possible to list all of the versions of `sugartex` available on your platform with:
